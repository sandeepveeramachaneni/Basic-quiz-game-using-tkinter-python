...
class Quiz:
	...
	def submit_btn(self):
		...
		if self.q_no==self.data_size or self.q_no!=self.data_size:
	...
	def buttons(self):
		...
		submit_button = Button(gui, text="Submit",command=self.submit_btn,
		width=10,bg="black",fg="white",font=("ariel",16,"bold"))
		
		submit_button.place(x=100,y=380)
